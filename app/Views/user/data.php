                ...
                <div class="card-header">
                    ...
                    <nav class="navbar">
                        <div class="nav-item">
                            ...
                            <a class="btn btn-secondary" href="<?= base_url('admin/user'); ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                        </div>
                    </nav>
                    <!-- end button kembali -->
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="list_data">
                            ...
                            <div class="table-responsive mt-3">
                                <table id="detail-user" class="table align-items-center table-flush table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 100px;">
                                                <a class="btn btn-primary btn-sm" href="<?= base_url('admin/user/detail/'.$rwyt->id_login); ?>"><i class="fa fa-info-circle" aria-hidden="true"></i> Detail</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
