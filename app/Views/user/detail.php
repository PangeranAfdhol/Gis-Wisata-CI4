        ...
        <div class="col-xl-12">
            <div class="card" style="min-height: 430px;">
                <div class="card-header">
                    ...
                    <nav class="navbar">
                        <div class="nav-item">
                            ...
                            <a class="btn btn-secondary" href="<?= base_url('admin/user/data/'.$id_user); ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                        </div>
                    </nav>
                    <!-- end button kembali -->
                </div>
                <div class="card-body">
                    ...
                    { ?>
                        <div style="width: 100%; height: 400px" id="mapDetailLoginUser"></div>
...
<?= $this->section('javascript') ?>
    ...
    <script>
        ...
        var map = new L.map('mapDetailLoginUser', {
